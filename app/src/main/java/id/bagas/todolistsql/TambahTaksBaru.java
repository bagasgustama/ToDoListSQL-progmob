...
import id.bagas.todolistsql.Model.ModelToDo;
import id.bagas.todolistsql.Utils.HalperDataBase;
...
public class TambahTaksBaru extends BottomSheetDialogFragment {
    ...
    public static id.bagas.todolistsql.TambahTaksBaru newInstance(){
        return new id.bagas.todolistsql.TambahTaksBaru();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.layout_newtaks,
                container, false);
        return v;
    }
        ...
        mEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.toString().equals("")){
                    ...
                    mSaveButton.setBackgroundColor(getResources().getColor
