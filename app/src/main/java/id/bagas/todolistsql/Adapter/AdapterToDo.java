package id.bagas.todolistsql.Adapter;
...
import id.bagas.todolistsql.MainActivity;
import id.bagas.todolistsql.Model.ModelToDo;
import id.bagas.todolistsql.R;
import id.bagas.todolistsql.TambahTaksBaru;
...
public class AdapterToDo extends RecyclerView.Adapter<AdapterToDo.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate
                (R.layout.layout_task, parent, false);
